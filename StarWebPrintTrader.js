...
var StarWebPrintTrader = function (a) {
    ...
    void 0 != a &&
      ...
      void 0 != a.holdprint_timeout && (this.holdprint_timeout = a.holdprint_timeout));
  },
  _handlerCallback = {};
...
StarWebPrintTrader.prototype._callMessageHandler = function () {
  ...
  null == _handlerCallback[a._url]
    ? ((_handlerCallback[a._url] = a), webkit.messageHandlers.sendMessageHandler.postMessage(a._json))
    : setTimeout(function () {
...
StarWebPrintTrader.prototype.sendMessage = function (a) {
  ...
  void 0 != a.holdprint_timeout
    ...
    : void 0 != this.holdprint_timeout && (b += ' holdprint_timeout="' + this.holdprint_timeout + '"');
  ...
  if (
    ...
    (this._json = JSON.stringify({ url: b, body: c })), (this._url = b), this._callMessageHandler();
  else {
    var d = null;
...
window.star.StarWebPrintTrader = StarWebPrintTrader;
