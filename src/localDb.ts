          ...
          realm.write(() => {
            ...
            detailsSnapshot.forEach((detailDoc) => {
              ...
              realm.create<SaleDetailLocal>('SaleDetail', {
                ...
                hidden: saleDetail.product.hidden ?? false,
                unregistered: saleDetail.product.unregistered ?? false,
                sellingPrice: Number.isNaN(saleDetail.product.sellingPrice) ? 0 : saleDetail.product.sellingPrice ?? 0,
                costPrice: Number.isNaN(saleDetail.product.costPrice) ? 0 : saleDetail.product.costPrice ?? 0,
                avgCostPrice: saleDetail.product.avgCostPrice ?? 0,
                sellingTaxClass: saleDetail.product.sellingTaxClass ?? null,
                stockTaxClass: saleDetail.product.stockTaxClass ?? null,
                sellingTax: saleDetail.product.sellingTax ?? null,
                stockTax: saleDetail.product.stockTax ?? null,
                selfMedication: saleDetail.product.selfMedication ?? false,
                supplierCode: saleDetail.product.supplierRef ? saleDetail.product.supplierRef.id : null,
                noReturn: saleDetail.product.noReturn ?? false,
